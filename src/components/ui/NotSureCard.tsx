    ...
    return (
        <Card className='bg-[#340863] rounded-[12px] border border-[#7D31D87A] shadow-[0_0_12px_0_rgba(125,49,216,0.47)]'>
            <div className="flex flex-col items-center text-center px-4 pt-3 pb-2">
                <h2 className="text-[22px] font-bold text-[#18FE6C] leading-tight mb-1 text-center">
                    You're on track — each step reveals how to master better decisions.
                </h2>
                <p className="text-[14px] text-[#E2D9F7] font-normal leading-tight text-center mb-2">
                    ...
                    <div className="px-4 pb-1">
                        <div className="text-center">
                            ...
                            <div className="flex items-center justify-center mb-0">
                                ...
                                <h3 className="text-white text-[16px] font-semibold mt-1">
                                    {traderInfo?.archetype}
                                </h3>
                            </div>

                            {/* Quote */}
                            <p className="text-white/90 text-[14px] italic mb-0">
                                {traderInfo?.quote}
                            </p>
                        </div>
                    </div>
